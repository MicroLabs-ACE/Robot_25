    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6">
        <button
          ...
          className={`flex items-center py-3 px-4 font-medium transition-colors border-b-2 ${activeTab === 'pending'
        ...
        <button
          ...
          className={`flex items-center py-3 px-4 font-medium transition-colors border-b-2 ${activeTab === 'preparing'
              ? 'border-orange-500 text-orange-500'
              : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
            }`}
        >
        ...
        <button
          ...
          className={`flex items-center py-3 px-4 font-medium transition-colors border-b-2 ${activeTab === 'delivered'
              ? 'border-orange-500 text-orange-500'
              : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300'
            }`}
        >
          ...
          {filteredOrders.length === 0 ? (
            ...
            <div className="space-y-4">
              {filteredOrders.map((order) => (
                <div
                  key={order.id}
                  className={`bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all hover:shadow-lg ${selectedOrder?.id === order.id ? 'ring-2 ring-orange-500' : ''
                    }`}
