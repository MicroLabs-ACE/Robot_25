      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-10">
            ...
            <div className="card p-6 border overflow-hidden flex flex-col">
              {/* REPLACE THE src URL BELOW WITH YOUR PREFERRED IMAGE */}
              <div className="w-full h-48 mb-4 overflow-hidden rounded-lg">
                <img
                  src="public/jollof-meat-coke.png"
                  alt="Rice & Meat + Coke"
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                />
              </div>
              <h3 className="font-semibold text-xl">Rice & Meat + Coke</h3>
              <p className="text-orange-500 font-bold mt-1">₦3,400</p>
            ...
            <div className="card p-6 border overflow-hidden flex flex-col">
              ...
              <div className="w-full h-48 mb-4 overflow-hidden rounded-lg">
                <img
                  src="public/jollof-chicken-moimoi.png"
                  alt="Jollof Rice Combo"
                  className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                />
              </div>
              <h3 className="font-semibold text-xl">Jollof Rice Combo</h3>
              <p className="text-orange-500 font-bold mt-1">₦5,500</p>
              <div className="flex justify-center items-center gap-2 mt-3 text-gray-500">
                <Clock size={16} />
                <span>20 mins</span>
              </div>
